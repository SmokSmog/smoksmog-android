node {
    ...
    slackSend channel: 'quality', color: '#0080FF', message: "Started Android ${env.JOB_NAME} ${env.BUILD_NUMBER} (<${env.BUILD_URL}|Open>)", teamDomain: 'smoksmog', tokenCredentialId: 'smoksmok-slack'
